...
export function KeywordSearch({ value, onChange, placeholder = 'Palavra-chave', style }: KeywordSearchProps) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', flex: '1 1 220px', minWidth: 180, maxWidth: '100%', height: 32, backgroundColor: '#FFFFFF', border: `1px solid ${colors.surface.medium}`, borderRadius: '4px', paddingLeft: '12px', paddingRight: '10px', boxSizing: 'border-box', ...style }}>
